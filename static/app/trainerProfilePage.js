Vue.component("trainer-profile-page", {
	data: function () {
		return {
			user: null,
			valid: true,
				...
				<div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				        <li v-on:click="trainerHome" class="nav-item">
				          <a class="nav-link pointer">Home</a>
				        </li>
				      </ul>
					  <ul class="navbar-nav">
						<li class=nav-item>
							<a v-on:click="trainerProfile" class="nav-link ms-3 pointer active"><i class="fa fa-user me-1" aria-hidden="true"></i>Profile</a>
						</li>
						<li class=nav-item>
